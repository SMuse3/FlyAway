...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="<%=ATBView.FLIGHT_CTL%>">Add A Flight</a></li>
          <li><a href="<%=ATBView.FLIGHT_LIST_CTL%>">Flight Report</a></li>
          <li><a href="<%=ATBView.BOOK_LIST_CTL%>">Ticket Booking Report</a></li>
    ...
    <%} %>
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><%=welcomeMsg%><span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="<%=ATBView.LOGIN_CTL%>?operation=<%=LoginCtl.OP_LOG_OUT%>">Log Out</a></li>
        </ul>
      </li>
